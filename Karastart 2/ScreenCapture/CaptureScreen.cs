...
namespace ScreenshotCaptureWithMouse.ScreenCapture
{
    public class CaptureScreen
    {
        ...
        public static Bitmap CaptureDesktop(int left, int top, int width, int height)
        {
            SIZE size;
            IntPtr hBitmap;
            ...
            size.cx = width;// Win32Stuff.GetSystemMetrics(Win32Stuff.SM_CXSCREEN);

            size.cy = height;// Win32Stuff.GetSystemMetrics(Win32Stuff.SM_CYSCREEN);
            ...
            if (hBitmap != IntPtr.Zero)
            {
                ...
                GDIStuff.BitBlt(hMemDC, 0, 0, size.cx, size.cy, hDC, left, top, GDIStuff.SRCCOPY);
        ...
        public static Bitmap CaptureDesktopWithCursor()
        {
            ...
            desktopBMP = CaptureDesktop(0,0,Win32Stuff.GetSystemMetrics(Win32Stuff.SM_CXSCREEN),Win32Stuff.GetSystemMetrics(Win32Stuff.SM_CYSCREEN));

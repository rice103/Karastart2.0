...
namespace KaraStart
{
    ...
    public static class SistemVolumChanger
    {
        public static void SetMuteUnmute(bool muting)
        {
            ...
            {
                SetMuteForWIndowsVista78(muting);
            }
            else
            {
                SetMuteForWIndowsVista78(muting);
        ...
        public static void SetVolume(int value0To100)
        {
            int value = value0To100;
            if (value < 0)
                value = 0;
        ...
        public static bool isMuted()
        {
            ...
            try
            {
                MMDeviceEnumerator DevEnum = new MMDeviceEnumerator();
                MMDevice device = DevEnum.GetDefaultAudioEndpoint(EDataFlow.eRender, ERole.eMultimedia);
                result = (bool)(device.AudioEndpointVolume.Mute);
            }
            catch (Exception)
            {
            }
        ...
        private static void SetMuteForWIndowsVista78(bool muting)
        {
            try
            {
                MMDeviceEnumerator DevEnum = new MMDeviceEnumerator();
                ...
                device.AudioEndpointVolume.Mute = muting;
            }
            catch (Exception)
            {
            }
        ...
        private static void SetMuteForWIndowsXP(bool muting)
        {
            SetVolumeForWIndowsXP(0);
        }
